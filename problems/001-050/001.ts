...
/** 
 * To calculate, we need to sum up all the multiples of 3 and 5 under 1000, then minus the sum of multiples of 15 for the reason that multiples of 15 were counted once more than it should.
 */
